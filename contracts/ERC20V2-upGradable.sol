...
contract ERC20V2 is IERC20{
    ...
    function initializer() external {
        require(initialize == false, "initialize already ran");
        initialize = true ;
        name = "JToken";
        owner = msg.sender;
        ownerName = "jay";
    ...
    // check balance 
    function balanceOf(address sender) external view returns(int){
    ...
    function transferfrom(address sender , address reciver , int amount) external override returns(bool){
    ...
    // new function to get the name of owner 
